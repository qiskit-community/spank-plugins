...
/// Get usage analytics
pub async fn analytics_usage(configuration: &configuration::Configuration, ibm_api_version: Option<&str>, instance: Option<Vec<String>>, interval_start: Option<String>, interval_end: Option<String>, backend: Option<Vec<String>>, user_id: Option<Vec<String>>, simulators: Option<bool>) -> Result<models::AnalyticsUsage200Response, Error<AnalyticsUsageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ibm_api_version = ibm_api_version;
    let p_instance = instance;
...
pub async fn get_usage_analytics_grouped(configuration: &configuration::Configuration, group_by: &str, ibm_api_version: Option<&str>, instance: Option<Vec<String>>, interval_start: Option<String>, interval_end: Option<String>, backend: Option<Vec<String>>, user_id: Option<Vec<String>>, simulators: Option<bool>) -> Result<models::GetUsageAnalyticsGrouped200Response, Error<GetUsageAnalyticsGroupedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_usage_analytics_grouped_by_date(configuration: &configuration::Configuration, group_by: &str, ibm_api_version: Option<&str>, instance: Option<Vec<String>>, interval_start: Option<String>, interval_end: Option<String>, backend: Option<Vec<String>>, user_id: Option<Vec<String>>, simulators: Option<bool>) -> Result<models::GetUsageAnalyticsGroupedByDate200Response, Error<GetUsageAnalyticsGroupedByDateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_group_by = group_by;
    let p_ibm_api_version = ibm_api_version;
    let p_instance = instance;
